<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/css/stylefooter.css')?>">
        ...
        <footer id="site-footer" class="">
            ...
            <div class="lower-footer container-fluid p-4">
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="list-unstyled d-flex" >
                            <li class="p-4"><a href="/legal" data-value="Legal" data-type="CTALink" data-section="Footer" class="text-dark">Legal</a></li>
